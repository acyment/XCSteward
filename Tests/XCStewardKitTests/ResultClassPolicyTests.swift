...
final class ResultClassPolicyTests: XCTestCase {
    ...
    func testSummaryLinesAreStable() {
        ...
        XCTAssertEqual(policy.summaryLine(for: .runnerBootstrapFailure), "Runner failed before XCTest attached")
    ...
    func testJUnitErrorMessagesOnlyCoverInfrastructureStyleRunFailures() {
        ...
        XCTAssertEqual(policy.junitErrorMessage(for: .runnerBootstrapFailure), "Runner failed before XCTest attached")
