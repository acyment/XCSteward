...
description: Use when Codex needs to run, monitor, or diagnose iOS Simulator tests through XCSteward in this repository. Use the CLI JSON contract directly; do not add an MCP or protocol wrapper.
---
